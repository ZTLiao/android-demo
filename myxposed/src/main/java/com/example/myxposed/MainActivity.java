...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("myXposed MainActivity", teacher1.toString());
        Log.i("myXposed MainActivity", teacher2.toString());
        Log.i("myXposed MainActivity", teacher3.toString());
        Log.i("myXposed MainActivity", teacher4.toString());
    }
