...
public class ElfType32 {
    ...
    public List<ElfStringTable> elfStringTables = new ArrayList<>();  //下标0是节区字符串表
    public List<ElfSymbolTable> elfSymbolTableList = new ArrayList<ElfSymbolTable>();
...
//            System.out.println();
//            int symName_off = Utils.byte2Int(symList.get(i).st_name);
//            String symName = elfStringTableList.get(1).readCStringByOffset(symName_off);
//            System.out.println("The "+(i)+" Symbol Table:" + symName);
...
//    }
    ...
    public class elf32_hdr {
        ...
        public ArrayList<byte[]> em = new ArrayList<>();
